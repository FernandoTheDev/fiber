...
{
private:
    bool[512] occupied; // flag para cada posição da memória
public:
...
public:
    ...
    void run()
    {
        ...
        writeln("Program terminated (end of code).");
    }
...
// void main()
// {
//     int[512] mem; // CORREÇÃO: removido 'new'
//     for (int i = 0; i < 512; i++)
//     {
//         mem[i] = 0; // CORREÇÃO: inicializar a memória
//     }

//     // Programa de exemplo que trabalha com strings
//     FiberVM vm = new FiberVM(cast(int[])[], mem);
...
//     int[] prog = [
//         OpCode.CALL, 4, // Chama função no endereço 5
//         OpCode.JMP, 22, // CORREÇÃO: Pula para HALT (endereço correto)

//         // Função que trabalha com strings (endereço 5)
